  ...
  return (
    ...
    >
      ...
      <div className='flex items-center gap-3'>
        {liveHref ? (
          <a href={liveHref} target='_blank' rel='noopener noreferrer' onClick={(e) => e.stopPropagation()} className='text-sm text-primary underline flex items-center gap-1.5 font-semibold' aria-label={`Open live demo for ${project.title}`}>
        ...
        {codeHref ? (
          <a href={codeHref} target='_blank' rel='noopener noreferrer' onClick={(e) => e.stopPropagation()} className='text-sm text-white/80 sm:text-white/70 underline flex items-center gap-1 font-semibold' aria-label={`Open source code for ${project.title}`}>
