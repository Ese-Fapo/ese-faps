            ...
            <FadeIn delay={100}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold sm:font-bold text-white leading-tight mb-4 md:mb-6 tracking-tight">
                <Trans
                  ...
                  components={{
                    react: (
                      <span className="text-lime-300 drop-shadow-[0_0_14px_rgba(141,255,105,0.45)]" />
                    ),
                    uiux: (
                      <span className="text-fuchsia-300 italic underline decoration-fuchsia-400/80 underline-offset-8 px-1" />
                    ),
                  }}
                />
              </h1>
